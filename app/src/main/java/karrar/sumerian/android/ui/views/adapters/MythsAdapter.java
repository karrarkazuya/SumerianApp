...
public class MythsAdapter  extends ArrayAdapter<JSONArray> {

    private final Activity context;
    private final JSONArray jsonobjects;

    public MythsAdapter(Activity context, JSONArray objects) {
        ...
        try {
            ...
            rowView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    context.startActivity((new Intent(context, MythViewer.class).putExtra("pos", position)));
                }
            });
